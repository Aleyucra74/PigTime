                        ...
                        <div class="accordion d-lg-flex w-100" id="accordion">
                            ...
                            <div class="col-lg-4 col-md-12">
                                ...
                                <div class="collapse text-white d-lg-flex" data-parent="#accordion" id="one">
                                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Eligendi voluptatibus ipsam pariatur doloribus necessitatibus dolores nemo, aspernatur a accusantium perspiciatis ratione, magni sint. Voluptates eveniet quisquam vel. Officiis, temporibus quae.
                                </div>
                                <!-- FINAL DA DIV -->
                            </div>
                            <!-- ELEMENTO DOIS -->
